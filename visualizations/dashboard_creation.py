...
ls = [type(item) for item in city_names]
print(ls)

app = dash.Dash(__name__, external_stylesheets=external_stylesheets)
"""app.layout = html.Div([
    dcc.Dropdown(id='group-select', options=[{'label': i, 'value': i} for i in city_names],
                           value='KHARTOUM', style={'width': '140px'}),
...
app.layout = html.Div([
    ...
    ddc.Graph(id='live-update-graph')
])
